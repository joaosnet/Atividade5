...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Atividade_5.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ativiade5.sopcinfo
...
# Design Name 
# setting SOPC_NAME is ativiade5
SOPC_NAME := ativiade5
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2000000
SOPC_SYSID_FLAG += --sidp=0x2000000
ELF_PATCH_FLAG  += --sidp 0x2000000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1730742964
SOPC_SYSID_FLAG += --timestamp=1730742964
ELF_PATCH_FLAG  += --timestamp 1730742964
