...
module ativiade5_mm_interconnect_0 (
	...
	wire   [26:0] eth_tse_0_control_port_agent_m0_address;                                            // eth_tse_0_control_port_agent:m0_address -> eth_tse_0_control_port_translator:uav_address
	...
	wire  [105:0] eth_tse_0_control_port_agent_rf_source_data;                                        // eth_tse_0_control_port_agent:rf_source_data -> eth_tse_0_control_port_agent_rsp_fifo:in_data
	...
	wire  [105:0] eth_tse_0_control_port_agent_rsp_fifo_out_data;                                     // eth_tse_0_control_port_agent_rsp_fifo:out_data -> eth_tse_0_control_port_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> eth_tse_0_control_port_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // eth_tse_0_control_port_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> eth_tse_0_control_port_agent:cp_channel
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_1_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [104:0] eth_tse_0_control_port_agent_rp_data;                                               // eth_tse_0_control_port_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [104:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_010:sink_data
	...
	ativiade5_mm_interconnect_0_router_002 router_010 (
	...
	ativiade5_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (spi_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ativiade5_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (spi_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
